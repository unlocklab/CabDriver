...
public class Validations {
    ...
    public static boolean valEdit2(Activity activity, TextView editText, String name)
    {
        if(editText!=null && activity!=null && name!=null) {
            if (editText.getText().toString().length() == 0) {
                Toast.makeText(activity.getApplicationContext(), activity.getString(R.string.plase_ch) + " " + name, Toast.LENGTH_SHORT).show();
                return false;
            } else {
                return true;
            }
